...
import {ResolvedOrder, ResolvedOrderV2, OutputToken} from "../../../src/base/ReactorStructs.sol";
import {IProtocolFeeController, IProtocolFeeControllerV2} from "../../../src/interfaces/IProtocolFeeController.sol";
...
/// @notice Mock protocol fee controller
contract MockFeeControllerV2 is IProtocolFeeControllerV2, Owned(msg.sender) {
    uint256 private constant BPS = 10000;
    address public immutable feeRecipient;
    ...
    function getFeeOutputs(ResolvedOrderV2 memory order) external view override returns (OutputToken[] memory result) {
        result = new OutputToken[](order.outputs.length);
