...
contract SwapRouter02IntegrationTest is Test, PermitSignature {
    ...
    function testSwapWethToDaiViaAggregator() public {
        ...
        dloReactor.execute(
            ...
            address(executor),
            abi.encode(tokensToApproveForAggregator, tokensToApproveForReactor, swapData1)
        );
        ...
        dloReactor.execute(
            ...
            address(executor),
            abi.encode(new address[](0), new address[](0), swapData2)
        );
    ...
    function testSwapWethToDaiViaAggregatorInsufficientOutput() public {
        ...
        dloReactor.execute(
            ...
            address(executor),
            abi.encode(tokensToApproveForSwapRouter02, tokensToApproveForReactor, swapData)
        );
    }
