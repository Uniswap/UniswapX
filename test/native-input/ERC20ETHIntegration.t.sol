...
contract ERC20ETHIntegrationTest is Test, DeployPermit2, PermitSignature, DelegationHandler {
    ...
    V3DutchOrderReactor public reactor;
    ...
    function setUp() public {
        ...
        // Deploy reactor
        reactor = new V3DutchOrderReactor(permit2, PROTOCOL_FEE_OWNER);
    ...
    function test_V3DutchOrderWithNativeInput() public {
        ...
        V3DutchOrder memory order = V3DutchOrder({
            info: OrderInfoBuilder.init(address(reactor)).withSwapper(address(signerAccount)),
