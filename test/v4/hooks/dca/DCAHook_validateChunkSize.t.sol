...
contract DCAHook_validateChunkSizeTest is Test, DeployPermit2 {
    ...
    function test_validateChunkSize_exactOut_validChunkAtMaximum() public view {
        DCAIntent memory intent = hook.createTestIntent(SWAPPER, NONCE, false, MIN_CHUNK_SIZE, MAX_CHUNK_SIZE);
        DCAOrderCosignerData memory cosignerData = hook.createTestCosignerData(SWAPPER, NONCE, MAX_CHUNK_SIZE, 120e18, 1);
    ...
    function test_validateChunkSize_exactIn_largeValues() public view {
        ...
        DCAOrderCosignerData memory cosignerData = hook.createTestCosignerData(SWAPPER, NONCE, execAmount, desiredOutput, 1);
    ...
    function testFuzz_validateChunkSize_exactIn_validRange(
        uint256 minChunk,
        uint256 maxChunk,
        uint256 execAmount
    ) public view {
        ...
        DCAIntent memory intent = hook.createTestIntent(SWAPPER, NONCE, true, minChunk, maxChunk);
        DCAOrderCosignerData memory cosignerData = hook.createTestCosignerData(SWAPPER, NONCE, execAmount, execAmount / 2, 1);
    ...
    function testFuzz_validateChunkSize_exactIn_revertBelowMin(
        uint256 minChunk,
        uint256 maxChunk,
        uint256 execAmount
    ) public {
    ...
    function testFuzz_validateChunkSize_exactIn_revertAboveMax(
        uint256 minChunk,
        uint256 maxChunk,
        uint256 execAmount
    ) public {
    ...
    function testFuzz_validateChunkSize_exactOut_revertBelowMin(
        uint256 minChunk,
        uint256 maxChunk,
        uint256 execAmount
    ) public {
        ...
        DCAIntent memory intent = hook.createTestIntent(SWAPPER, NONCE, false, minChunk, maxChunk);
        DCAOrderCosignerData memory cosignerData = hook.createTestCosignerData(SWAPPER, NONCE, execAmount, type(uint128).max, 1);
    ...
    function testFuzz_validateChunkSize_exactOut_revertAboveMax(
        uint256 minChunk,
        uint256 maxChunk,
        uint256 execAmount
    ) public {
    ...
    function testFuzz_validateChunkSize_exactIn_inputMismatch(
        uint256 execAmount,
        uint256 inputAmount
    ) public {
    ...
    function testFuzz_validateChunkSize_exactOut_inputAboveLimit(
        uint256 limit,
        uint256 inputAmount
    ) public {
