...
import {PriorityOrderReactorQuoter} from "../../src/reactors/PriorityOrderReactorQuoter.sol";
...
contract PriorityOrderReactorQuoterTest is PermitSignature, DeployPermit2, BaseReactorTest {
    ...
    function name() public pure override returns (string memory) {
        return "PriorityOrderReactorQuoter";
    }

    function createReactor() public override returns (BaseReactor) {
        return new PriorityOrderReactorQuoter(permit2, PROTOCOL_FEE_OWNER);
    }
    ...
    function testRevertsWithInputOutputScaling() public {
        ...
        vm.expectRevert(PriorityOrderReactorQuoter.InputOutputScaling.selector);
        fillContract.execute(signedOrder);
    }
    ...
    function testRevertsBeforeAuctionStartBlock() public {
        ...
        vm.expectRevert(PriorityOrderReactorQuoter.OrderNotFillable.selector);
        fillContract.execute(signedOrder);
    }
    ...
    function testRevertsInvalidTxGasPrice() public {
        ...
        vm.expectRevert(PriorityOrderReactorQuoter.InvalidGasPrice.selector);
        fillContract.execute(signedOrder);
    }
    ...
    function testCheckPermit2Nonce() public {
        ...
        vm.expectRevert(PriorityOrderReactorQuoter.OrderAlreadyFilled.selector);
        fillContract.execute(signedOrder);
