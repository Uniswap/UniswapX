...
interface IReactor {
    ...
    function execute(SignedOrder calldata order, bytes calldata fillData) external payable;
    ...
    /// @param fillData The fillData to pass to the fillContract callback
    function executeBatch(SignedOrder[] calldata orders, bytes calldata fillData) external payable;
}
