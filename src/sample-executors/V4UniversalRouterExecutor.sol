...
import {IReactorCallback} from "../v4/interfaces/IReactorCallback.sol";
import {IReactor} from "../v4/interfaces/IReactor.sol";
import {CurrencyLibrary, NATIVE} from "../lib/CurrencyLibrary.sol";
import {ResolvedOrder} from "../v4/base/ReactorStructs.sol";
import {SignedOrder} from "../base/ReactorStructs.sol";

/// @notice A fill contract that uses UniversalRouter to execute trades on V4 Reactor
contract V4UniversalRouterExecutor is IReactorCallback, Owned {
